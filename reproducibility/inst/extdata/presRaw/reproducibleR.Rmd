...
- [Set up](https://rockefelleruniversity.github.io/RU_ReproducibleR_abridged/presentations/singlepage/reproducibleR.html#Set_Up)
- [R Markdown](https://rockefelleruniversity.github.io/RU_ReproducibleR_abridged/presentations/singlepage/reproducibleR.html#R_Markdown)
...
Though the previous example is a good start, when we do some analysis the ideal situation is **ALL** aspects of the analysis in a single document. 
...
To start a new line in Markdown, you need to end the previous line with two spaces.
...
HTML links can also be included with similar nomenclature by including address in text or by using **[]** for the phrase to add link to, followed the link in **()**
